 ...
 */
export const MODEL_TIER_ALIASES = ['sonnet', 'haiku', 'opus'] as const
export type ModelTierAlias = (typeof MODEL_TIER_ALIASES)[number]

// ---------------------------------------------------------------------------
// Per-provider model config record
// ---------------------------------------------------------------------------
...
const PREFERRED_MODEL_KEYS_BY_PROVIDER: Record<APIProvider, Record<ModelTier, ModelKey>> = {
...
function catalogModelIds(catalog: ModelCatalog | null | undefined, provider: APIProvider): string[] {
